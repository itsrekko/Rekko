...
export const defaultPost = {
  ...
  user: defaultUser,
  media:
    'https://blog.hootsuite.com/wp-content/uploads/2022/09/Instagram-notes-556x556.png',
  comments: [],
  created_at: '2020-02-28T03:08:14.522421+00:00',
}

export const defaultRekko = {
  id: uuid(),
  likes: 10,
  caption: `<span class="">Do you know the 10 JavaScript concepts you need to learn React? 🤔⚛️👇<br>•<br>•<br>👉 Get the FREE cheatsheet to learn them now: bit.ly/10-js-tips 🔥</span>`,
  user: defaultUser,
...
export function getDefaultRekko() {
...
export const defaultCurrentUser = {
  ...
  rekkos: Array.from({ length: 10 }, () => getDefaultRekko()),
